 ...
 * GDPR, etc. These configurations are globally applicable for OpenWrap SDK; you don't have to set
...
export class OpenWrapSDK {
   ...
   * For more details refer <a href="https://www.iab.com/guidelines/ccpa-framework/">
   *     IAB CCPA Compliance Framework </a>
   * Make sure that the string value you use is compliant with the IAB Specification, refer
   * <a href="https://iabtechlab.com/wp-content/uploads/2019/11/U.S.-Privacy-String-v1.0-IAB-Tech-Lab.pdf">
   *     IAB Tech Lab PDF </a>
   * <p>
   ...
   */
  public static setCCPA(ccpaString: string) {
    OpenWrapSDKModule.setCCPA(ccpaString);
  }
   ...
   */
  public static setGDPREnabled(gdprEnabled: boolean) {
    OpenWrapSDKModule.setGDPREnabled(gdprEnabled);
  }
   ...
   *     GDPR-Transparency-and-Consent-Framework </a>.
   ...
   */
  public static setGDPRConsent(gdprConsent: string) {
    OpenWrapSDKModule.setGDPRConsent(gdprConsent);
  }
