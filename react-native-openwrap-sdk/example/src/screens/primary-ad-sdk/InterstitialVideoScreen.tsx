...
/**
 * Screen to display interstitial video ads
 */
const InterstitialVideoScreen = () => {
  let interstitial: POBInterstitial | undefined;

  const onPressLoadAd = () => {
    // Create POBInterstitial Ad instance by passing required ad unit details,
    // like publisher id, profile id and ad unit id.
    ...
    // Set optional listener to receive video events
    interstitial?.setVideoListener(new InterstitialVideoListener());
 ...
 */
class InterstitialVideoListener implements POBVideoListener {
  // Callback method notifies that playback of the VAST video has been completed
  onVideoPlaybackCompleted(_: POBInterstitial): void {
    console.log(`Interstitial video ad event : Complete`);
  }
}
...
export default InterstitialVideoScreen;
